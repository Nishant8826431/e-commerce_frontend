            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                  ...
                  <div>
                      <Link to="/admin/product-form"  className="rounded-md mx-8 bg-green-600 my-2 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add New Product</Link>
                    </div>
            ...
            {product?.map((product) => (
              <Link to={`/product-detail/${product.id}`}>
                ...
                >
                  ...
                  <div>
                      <button  className="rounded-md bg-indigo-600 my-2 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Edit Product</button>
                    </div>
                </div>
              </Link>
