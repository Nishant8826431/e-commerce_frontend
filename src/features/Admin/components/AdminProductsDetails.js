...
import { fetchAllProductsbyIDAsync, selectProductById } from '../../product-list/ProductSlice';
...
//TODO : In server data we will add some of these things
  return (
    <div className="bg-white">
      {product && product ? <div className="pt-6">
