...
function Checkout() {
  ...
  const handleAddress =(e)=>{
    ...
    setselectdAddress(user.addresses[e.target.value]);
  }
  ...
  const handleOrder =(e)=>{
    const order = {items, totalAmount , totalItems, user, paymentMethod , selectdAddress, status:"pending"}
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className="lg:col-span-3">
          <form className="bg-white px-5 py-5"  noValidate
              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <ul role="list" className="divide-y divide-gray-100">
                  {user?.addresses?.map((address, index) => (
                    <li
                      key={index}
                      className="flex justify-between px-5 gap-x-6 py-5"
                    >
       ...
       <h1 className="text-4xl my-8 font-bold tracking-tight text-gray-900">
                  Cart
                              ...
                              <li key={item.id} className="flex py-6">
                                ...
                                <div className="ml-4 flex flex-1 flex-col">
                                  <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">{item.brands}</p>
                                  </div>
                    ...
                    <div className="border-t border-gray-200 my-2 px-4 py-6 sm:px-4">
                      <div className="flex justify-between text-base font-medium text-gray-900">
                        <p>Subtotal</p>
                        <p>$ {totalAmount}</p>
                      </div>
